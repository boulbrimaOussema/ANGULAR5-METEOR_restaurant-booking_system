...
So add a file `both/collections/tables.collection.ts`

[{]: <helper> (diff_step 4.1)
#### Step 4.1: Add Parties collection

##### Added both/collections/tables.collection.ts
```diff
@@ -0,0 +1,3 @@
...
We've just created a file called `tables.collection.ts`, that contains a CommonJS module called `both/collections/parties`.
...
Let's create a file `server/imports/fixtures/tables.ts` and implement `loadParties` method inside to load parties:

[{]: <helper> (diff_step 4.5)
#### Step 4.5: Add initial Parties

##### Added server/imports/fixtures/tables.ts
```diff
@@ -0,0 +1,21 @@
...
##### Added both/models/table.model.ts
```diff
@@ -0,0 +1,5 @@
...
##### Changed both/collections/tables.collection.ts
```diff
@@ -1,3 +1,5 @@
...
##### Changed server/imports/fixtures/tables.ts
```diff
@@ -1,8 +1,9 @@
